...
Ext.define('transit.controller.transit', {
    extend: 'Ext.app.Controller',
	models: [
		'transit.model.agentModel',
		'transit.model.transitOrderModel',
		'transit.model.transitOrderGoodsModel',
		'transit.model.valueModel'],
    init: function() {
		...
		var agentsStore = Ext.create('Ext.data.Store', {
			model: 'transit.model.valueModel',
			proxy: {
				type: 'ajax',
		...
		var transitOrdersStore = Ext.create('Ext.data.Store', {
			model: 'transit.model.transitOrderModel',
			proxy: {
				type: 'rest',
		...
		var transitOrderGoodsStore = Ext.create('Ext.data.Store', {
			model: 'transit.model.transitOrderGoodsModel',
			proxy: {
				type: 'rest',
