Ext.define('ppsZoneEditor.controller.ppsZone', {
    ...
    init: function() {
		...
		var subdealersStore = Ext.create('Ext.data.Store', {
			model: 'ppsZoneEditor.model.valueModel',
			proxy: {
				type: 'ajax',
		...
		var zonesStore = Ext.create('Ext.data.Store', {
			model: 'ppsZoneEditor.model.zoneModel',
			proxy: {
				type: 'rest',
				url: '/pps_zone/zones',
				reader: {
		...
		var terminalsStore = Ext.create('Ext.data.Store', {
			model: 'ppsZoneEditor.model.terminalModel',
			proxy: {
				type: 'rest',
