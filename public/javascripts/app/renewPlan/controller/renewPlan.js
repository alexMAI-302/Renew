...
Ext.define('renewPlan.controller.renewPlan', {
    extend: 'Ext.app.Controller',
	models: [
		'renewPlan.model.renewPlanModel',
		'renewPlan.model.siteStorageModel',
		'renewPlan.model.valueModel'
	],
    init: function() {
		...
		var siteStoragesStore = Ext.create('Ext.data.Store', {
			model: 'renewPlan.model.siteStorageModel',
			proxy: {
				type: 'rest',
		...
		var storagesStore = Ext.create('Ext.data.Store', {
			model: 'renewPlan.model.valueModel'
		});
		
		var renewPlansStore = Ext.create('Ext.data.Store', {
			model: 'renewPlan.model.renewPlanModel',
			sorters: [
				{
					property : 'send_ddate',
					direction: 'ASC'
