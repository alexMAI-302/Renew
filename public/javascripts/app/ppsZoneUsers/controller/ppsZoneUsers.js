...
Ext.define('ppsZoneUsers.controller.ppsZoneUsers', {
    extend: 'Ext.app.Controller',
	models: [
		'ppsZoneUsers.model.zoneUserModel',
		'ppsZoneUsers.model.valueModel'
	],
    init: function() {
		...
		var usersStore = Ext.create('Ext.data.Store', {
			model: 'ppsZoneUsers.model.valueModel',
			proxy: {
				type: 'rest',
		...
		var zoneUsersStore = Ext.create('Ext.data.Store', {
			model: 'ppsZoneUsers.model.zoneUserModel',
			proxy: {
				type: 'rest',
		...
		var zoneUsersPanel=Ext.create('Ext.grid.Panel', {
			...
			tbar: [{
				...
				handler : function() {
					...
					var r = Ext.ModelManager.create({is_new: true}, 'ppsZoneUsers.model.zoneUserModel');
